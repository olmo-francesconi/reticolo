...
#
# Only the backend kernel TUs are scanned: SRC_DIR/*.cu. The validation
# harnesses under SRC_DIR/probes/ are deliberately NOT scanned — they
# legitimately *instantiate* the generic integrator (alg::integ::Leapfrog) as
# a type parameter, which is reuse, not a reimplemented integrator-specific
# kernel. bench_hmc.cu and profile_hmc.cu (perf / profiling harnesses) do the
# same and are skipped by name.
#

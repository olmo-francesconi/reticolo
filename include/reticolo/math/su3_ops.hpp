...
// NOTE: the per-link formulas (idx_re/idx_im, mul_3x3/mul_adj_3x3/adj_mul_3x3,
// traceless_antiherm_3x3, exp_su3) are single-sourced in
// math/group/formula/su3_formula.hpp, RETICOLO_HD so the CUDA device path
// (cuda::SU3Device, cuda/gauge/su3_device.cuh) forwards to them directly
// instead of re-implementing them — mechanically gated by
// tests/cuda/check_no_gauge_kernels.cmake, not just test_cuda_su3.
//

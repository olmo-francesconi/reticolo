...
// on which field it has: Lattice<T> reports nsites(); MatrixLinkLattice<G,T>
// reports ndim * 2N² * nsites (the raw real-component count). One overload
// per field — picked at compile time by ADL.

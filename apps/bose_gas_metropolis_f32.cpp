// Local Metropolis counterpart of `bose_gas_hmc_f32` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    // ---- CLI ----
    cli::Parser p{"bose_gas_metropolis_f32",
                  "Single-precision (mixed) phase-quenched local Metropolis for the 4D Bose gas"};

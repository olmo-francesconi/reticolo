// Local Metropolis counterpart of `su3_hmc_f32` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    cli::Parser p{"su3_metropolis_f32",
                  "SU(3) Wilson action, single-precision (mixed) local Metropolis"};

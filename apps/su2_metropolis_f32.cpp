// Local Metropolis counterpart of `su2_hmc_f32` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    cli::Parser p{"su2_metropolis_f32",
                  "SU(2) Wilson action, single-precision (mixed) local Metropolis"};

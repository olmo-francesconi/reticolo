// Local Metropolis counterpart of `phi6_hmc` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    // ---- CLI ----
    cli::Parser p{"phi6_metropolis", "Local Metropolis for the phi^6 scalar field"};
    auto const cf      = app::common_flags(p, {.out = "phi6_metropolis.h5"});

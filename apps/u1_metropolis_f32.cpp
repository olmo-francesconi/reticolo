// Local Metropolis counterpart of `u1_hmc_f32` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    using Field  = MatrixLinkLattice<math::group::U1, float>;

    // ---- CLI ----
    cli::Parser p{"u1_metropolis_f32",
                  "Compact U(1) Wilson action, single-precision (mixed) local Metropolis"};

// Local Metropolis counterpart of `phi6_hmc_f32` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    // ---- CLI ----
    cli::Parser p{"phi6_metropolis_f32",
                  "Single-precision (mixed) local Metropolis for the phi^6 scalar field"};
    auto const cf      = app::common_flags(p, {.out = "phi6_f32_metropolis.h5"});
    ...
    updater::Metropolis metro{phi6, phi, FastRng{cf.seed}, {.sigma = rf.sigma}};

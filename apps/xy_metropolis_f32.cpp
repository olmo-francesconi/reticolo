// Local Metropolis counterpart of `xy_hmc_f32` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    // ---- CLI ----
    cli::Parser p{"xy_metropolis_f32",
                  "Single-precision (mixed) local Metropolis for the XY (planar rotor) model"};
    auto const cf    = app::common_flags(p, {.out = "xy_f32_metropolis.h5"});

// Local Metropolis counterpart of `sine_gordon_hmc` — same physics, sampled by a
...
int main(int argc, char** argv) {
    ...
    // ---- CLI ----
    cli::Parser p{"sine_gordon_metropolis", "local Metropolis for the sine-Gordon scalar field"};
    auto const cf     = app::common_flags(p, {.out = "sine_gordon_metropolis.h5"});

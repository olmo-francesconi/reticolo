# 08 — smoothed LLR vs vanilla LLR
...
See `Orchestrator::run_smoothed` in `include/reticolo/orch/llr/orchestrator.hpp`
for the parameter surface (`SmoothConfig`).
...
```sh
cd examples/08_u1_llr_smoothed
